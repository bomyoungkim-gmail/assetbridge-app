...
// scraping ficam catalogados com execução deferida (ADR-0010, sem amostra).
export default async function FontesPage() {
  ...
  return (
    <section>
      <h1>Fontes de enriquecimento</h1>
      <p>
        ...
        identidade — só enriquece (ADR-0010). Cadastre uma fonte-<code>api</code>{" "}
        e ela liga no grafo na hora; <code>csv</code>/<code>scraping</code> ficam
        catalogados com execução deferida.
      </p>
